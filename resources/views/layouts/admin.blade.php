      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         @if (Auth::user()->role==1)
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ (request()->is('dashboard/aboutus')) ? 'active': '' }}{{ (request()->is('dashboard/privacy-policy')) ? 'active': '' }}{{ (request()->is('dashboard/contact')) ? 'active': '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('dashboard/aboutus') }}" class="nav-link {{ (request()->is('dashboard/aboutus')) ? 'active': '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>About Us</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ url('dashboard/privacy-policy') }}" class="nav-link {{ (request()->is('dashboard/privacy-policy')) ? 'active': '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Privacy Policy</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('dashboard/categorys') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Categorys</p>
                </a>
              </li>
          ...
          @if (Auth::user()->role==1)
          <li class="nav-item">
            <a href="{{ url('dashboard/recycle') }}" class="nav-link {{ (request()->is('dashboard/recycle*')) ? 'active': '' }}">
              <i class="nav-icon fas fa-recycle"></i><p> Recycle Bin </p>
            </a>
          </li>
          <li class="nav-item">
