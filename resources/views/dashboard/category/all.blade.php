          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <div class="input-group input-group-sm" style="width: 150px;">
                   <a class="btn btn-block btn-primary" href="{{ url('dashboard/category/add') }}">Add Category</a>
            ...
            <table id="myTable" class="table table-bordered table-hover text-nowrap">
              ...
              @foreach($allUser as $data)
                <tr>
                  ...
                  <td>{{ $data->cat_name }}</td>
                  <td>@if($data->cat_description!=""){{ Str::limit($data->cat_description, 30) }}@endif</td>
                  <td>
                    @php
                        $post=App\Models\Post::where('cat_id',$data->cat_id)->count();
                    @endphp
                    {{ $post }}
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="{{ url('dashboard/category/view/'.$data->cat_slug) }}">View</a>
                        <a class="dropdown-item" href="{{ url('dashboard/category/edit/'.$data->cat_slug) }}">Edit</a>
                        <a href="#" class="dropdown-item btn btn-danger" id="softDelete" data-toggle="modal" data-target="#modal-danger" data-id={{ $data->cat_id }}>Delete</a>
                      </div>
                    </div>
                  </td>
                </tr>
