              ...
              @csrf
                <div class="card-body">
                  <div class="form-group {{ $errors->has('name') ? ' has-error' : ''}}">
                    ...
                    <input type="name" name="name" class="form-control" id="name" value="{{ $data->cat_name }}">
                    @if ($errors->has ('name'))
                  ...
                  <div class="form-group {{ $errors->has('desc') ? ' has-error' : ''}}">
                    ...
                    <input type="text" name="desc" class="form-control" id="desc" value="{{ $data->cat_description }}">
                    @if ($errors->has ('desc'))
                     <span class="invalid-feedback" role="alert">
