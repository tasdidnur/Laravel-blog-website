        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Recycle Categorys</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="container-fluid">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">All Deleted Categorys</h3>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a href="#" class="dropdown-item btn btn-danger" id="restore" data-toggle="modal" data-target="#modal-danger" data-id={{ $data->cat_id }}>Restore</a>
                        <a href="#" class="dropdown-item btn btn-danger" id="delete" data-toggle="modal" data-target="#modal-dangers" data-id={{ $data->cat_id }}>Delete</a>
                      </div>
                    </div>
                  </td>
                </tr>
  ...
  <!-- /.modal -->
     <div class="modal fade" id="modal-dangers">
      <div class="modal-dialog">
        <form method="post" action="{{url('dashboard/category/delete')}}">
          @csrf
        <div class="modal-content bg-danger">
          <div class="modal-header">
