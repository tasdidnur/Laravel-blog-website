        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Post Resgistration</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Register Post</h3>
          ...
          <div class="card-body table-responsive p-0">
            <form method="post" action="{{ url('dashboard/post/submit') }}" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  ...
                  <div class="form-group {{ $errors->has('desc') ? ' has-error' : ''}}">
                    ...
                    <textarea rows="20" name="desc" class="form-control" id="summernote">{{ old('desc') }}</textarea>
                    @if ($errors->has ('desc'))
                     <span class="invalid-feedback" role="alert">
