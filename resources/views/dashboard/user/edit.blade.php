                ...
                <div class="card-body">
                  ...
                  <div class="form-group {{ $errors->has('role') ? ' has-error' : ''}}">
                    ...
                    <select name="role" class="custom-select rounded-0" id="role">
                      ...
                      <option value="{{ $role->role_id }}" @if($data->role==$role->role_id) selected @else '' @endif>{{ $role->role_name }}</option>
                      @endforeach
                    </select>
                    @if ($errors->has ('role'))
                     <span class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                        @if($data->image!='')
                        <img width="100" height="100" src='{{ asset('uploads/users/'.$data->image) }}'></img>
                        @else
                        <img width="100" height="100" src='{{ asset('uploads/users/ava.png') }}'></img>
                        @endif
                    </div>
                  </div>
                </div>
